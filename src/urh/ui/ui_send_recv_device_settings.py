...
class Ui_FormDeviceSettings(object):
    def setupUi(self, FormDeviceSettings):
        ...
        self.comboBoxSampleRate = QtWidgets.QComboBox(parent=self.frame_2)
        self.comboBoxSampleRate.setObjectName("comboBoxSampleRate")
        self.comboBoxSampleRate.setVisible(False)
        self.gridLayout.addWidget(self.comboBoxSampleRate, 8, 1, 1, 1)
